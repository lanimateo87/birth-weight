...
bw_median_data = bw_median.drop(['bwght',
                            'omaps',
                            'fmaps',
                            'fage',
                            'feduc',
...
print(bw_median_data)

# Train Data Set
bw_median_target = bw_median.loc[:, 'bwght']
